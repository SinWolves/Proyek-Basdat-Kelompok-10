            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <span style="font-family: 'Luxurious Roman'; color: black;">Personalized In-Room Dining</span>
                            <div class="increment-buttons">
                                <button class="btn btn-sm btn-light">-</button>
                                <input type="text" value="0" readonly>
                                <button class="btn btn-sm btn-light">+</button>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <span style="font-family: 'Luxurious Roman'; color: black;">24/7 In-Room Spa Services</span>
                            <div class="increment-buttons">
                                <button class="btn btn-sm btn-light">-</button>
                                <input type="text" value="0" readonly>
                                <button class="btn btn-sm btn-light">+</button>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-between align-items-center">
                            <span style="font-family: 'Luxurious Roman'; color: black;">Personal Fitness Trainer & Wellness Coach</span>
                            <div class="increment-buttons">
                                <button class="btn btn-sm btn-light">-</button>
                                <input type="text" value="0" readonly>
                                <button class="btn btn-sm btn-light">+</button>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-between align-items-center">
                            <span style="font-family: 'Luxurious Roman'; color: black;">Exclusive Kids Club with Personalized Activities</span>
                            <div class="increment-buttons">
                                <button class="btn btn-sm btn-light">-</button>
                                <input type="text" value="0" readonly>
                                <button class="btn btn-sm btn-light">+</button>
